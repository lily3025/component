...
<dl class="defdl">
    ...
    <dd>
        <div class="js_compCompExampleMoreAdvance">
            组件执行过程看控制台吧~
        </div>
    </dd>
</dl>
...
<script>
    ...
    requirejs( [ '{{path}}/examples/data/CompExampleMoreAdvance.js' ], function( BizExampleMoreAdvance ){
    }); 
</script>

```js
;(function(define, _win) { 'use strict'; define( [ 'module/JC.BaseMVC/0.1/BaseMVC' ], function(){
/**
 * 组件用途简述
 *
 *<p><b>require</b>:

...
define(['module/widget/1.0.1/widget','module/iscroll/5.1.1/iscroll','module/handlebars/1.0.0/handlebars','module/Nova.suggest/1.0.0/suggest','module/Nova.elevator/0.1.0/elevator','module/Nova.scrollTips/0.1.0/scrollTips','module/Nova.pagePanel/0.1.0/pagePanel'], factory);
} else {
root['CityPanel'] = factory();
}
...
PagePanel = PagePanel || this.PagePanel;
	...
	var initSuggest = function(){
		...
		suggScroll = new IScroll($('.suggest-wrap', cityPanel)[0], {
			hScrollbar: false,
			vScrollbar: false,
			bounce: false,
			tap: true
